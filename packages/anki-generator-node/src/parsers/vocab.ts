...
import type { VocabItem, MediaAsset, ParsedResult, ParsedCard, ParserOptions } from "../types/index.js";
...
export class VocabParser extends BaseParser {
  ...
  async parse(rawJson: string, options?: ParserOptions): Promise<ParsedResult> {
    ...
    const vocabList: VocabItem[] = JSON.parse(cleanRaw);
