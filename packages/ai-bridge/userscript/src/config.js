...
const DEFAULT_PROMPTS_KEY = "ai_bridge_default_prompts";
...
function getDefaultPrompts() {
  return GM_getValue(DEFAULT_PROMPTS_KEY, []);
}

function setDefaultPrompts(names) {
  GM_setValue(DEFAULT_PROMPTS_KEY, names);
}
